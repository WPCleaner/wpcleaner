...
public class CheckErrorAlgorithm016 extends CheckErrorAlgorithmBase {
  ...
  private enum ControlCharacter {
    ...
    THREE_PER_EM_SPACE(0x2004, 0x2004, false, false, GT._No("Thee-per-em space")),
    FOUR_PER_EM_SPACE(0x2005, 0x2005, false, false, GT._No("Four-per-em space")),
    SIX_PER_EM_SPACE(0x2006, 0x2006, false, false, GT._No("Six-per-em space")),
    FIGURE_SPACE(0x2007, 0x2007, false, false, GT._No("Figure space")),
    PUNCTUATION_SPACE(0x2008, 0x2008, false, false, GT._No("Punctuation space")),
    ...
    RIGHT_TO_LEFT_MARK(0x200F, 0x200F, true, false, GT._No("Right-to-left mark")),
