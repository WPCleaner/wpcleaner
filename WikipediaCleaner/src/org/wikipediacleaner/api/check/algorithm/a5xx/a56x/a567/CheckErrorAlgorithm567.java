...
public class CheckErrorAlgorithm567 extends CheckErrorAlgorithmBase {
  ...
  public boolean analyze(
    ...
    boolean result = analyzeFunctions(analysis, errors);
    return result;
  }
  ...
  private boolean analyzeFunction(
    ...
    if (Formatnum.isValidFormatnum(analysis, function)) {
      return false;
    }
    ...
    CheckErrorResult errorResult = createCheckErrorResult(analysis, function.getBeginIndex(), function.getEndIndex());
    new Formatnum(analysis, function, prefixes, suffixes).addSuggestions(errorResult);
