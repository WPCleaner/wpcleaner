...
public class CheckErrorComparator implements Comparator<CheckError> {
  ...
  public int compare(CheckError o1, CheckError o2) {
    ...
    int p1 = (a1 != null) ? a1.getPriority() : CheckError.PRIORITY_UNKOWN;
    int p2 = (a2 != null) ? a2.getPriority() : CheckError.PRIORITY_UNKOWN;
    if (p1 != p2) {
      return CheckError.comparePriority(p1, p2);
    }
