...
/**
 * Configuration for <a href="http://tr.wikipedia.org/w/index.php">Turkish wikipedia</a>.
 */
class WikiTr {

  private final static String baseUrl = "http://tr.wikipedia.org/w/";

  final static String code     = "tr";
  final static String name     = "Turkish Wikipedia";
  ...
  final static String checkWikiProject = "Vikipedi:Vikipedi proje kontrolü";
  final static String checkWikiTraduction = "Vikipedi:Vikipedi proje kontrolü/Çeviri";
}
