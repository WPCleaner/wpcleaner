...
/**
 * Configuration for <a href="http://cy.wikipedia.org/w/index.php">Welsh wikipedia</a>.
 */
class WikiCy {

  private final static String baseUrl = "http://cy.wikipedia.org/w/";

  final static String code     = "cy";
  final static String name     = "Welsh Wikipedia";
  ...
  final static String checkWikiTraduction = "Wicipedia:WikiProject Check Wikipedia/Translation";
}
