...
/**
 * Configuration for <a href="http://eo.wikipedia.org/w/index.php">Esperanto wikipedia</a>.
 */
class WikiEo {
  ...
  final static String checkWikiProject = "Projekto:Check Wikipedia";
  final static String checkWikiTraduction = "Projekto:Check Wikipedia/Tradukado";
}
