...
/**
 * Configuration for <a href="http://sk.wikipedia.org/w/index.php">Slovak wikipedia</a>.
 */
class WikiSk {

  private final static String baseUrl = "http://sk.wikipedia.org/w/";

  final static String code     = "sk";
  final static String name     = "Slovak Wikipedia";
  ...
  final static String checkWikiProject = "Wikipédia:WikiProjekt Check Wikipedia";
  final static String checkWikiTraduction = "Wikipédia:WikiProjekt Check Wikipedia/Translation";
}
