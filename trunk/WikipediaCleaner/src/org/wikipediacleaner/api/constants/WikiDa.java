...
/**
 * Configuration for <a href="http://da.wikipedia.org/w/index.php">Danish wikipedia</a>.
 */
class WikiDa {

  private final static String baseUrl = "http://da.wikipedia.org/w/";

  final static String code     = "da";
  final static String name     = "Danish Wikipedia";
  ...
  final static String checkWikiProject = "WP:WPCW";
  final static String checkWikiTraduction = "Wikipedia:WikiProjekt Check Wikipedia/Oversættelse";
}
