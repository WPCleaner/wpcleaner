...
/**
 * Configuration for <a href="http://pl.wikipedia.org/w/index.php">Polish wikipedia</a>.
 */
class WikiPt {

  private final static String baseUrl = "http://pt.wikipedia.org/w/";

  final static String code     = "pt";
  final static String name     = "Wikipédia em português";
  ...
  final static String message  = "Corrigindo ligação para página de desambiguação - [[:pt:Wikipedia:Coordenação robótica/desambiguação|Desambiguação assistida]]";
  ...
  final static String checkWikiProject = "Wikipedia:Projetos/Check_Wikipedia";
}
