...
/**
 * Configuration for <a href="http://nds-nl.wikipedia.org/w/index.php">Dutch Low Saxon wikipedia</a>.
 */
class WikiNdsNl {

  private final static String baseUrl = "http://nds-nl.wikipedia.org/w/";

  final static String code     = "nds-nl";
  final static String name     = "Dutch Low Saxon Wikipedia";
  ...
  final static String checkWikiProject = "Wikipedie:WikiProject Check Wikipedia";
  final static String checkWikiTraduction = "Wikipedie:WikiProject Check Wikipedia/Translation";
}
