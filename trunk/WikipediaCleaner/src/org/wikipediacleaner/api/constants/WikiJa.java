...
/**
 * Configuration for <a href="http://ja.wikipedia.org/w/index.php">Japanese wikipedia</a>.
 */
class WikiJa {

  private final static String baseUrl = "http://ja.wikipedia.org/w/";

  final static String code     = "ja";
  final static String name     = "Japanese Wikipedia";
  ...
  final static String checkWikiProject = "PJ:CW";
  final static String checkWikiTraduction = "Wikipedia:ウィキプロジェクト ウィキ文法のチェック/Translation";
}
