...
/**
 * Configuration for <a href="http://cs.wikipedia.org/w/index.php">Czech wikipedia</a>.
 */
class WikiCs {

  private final static String baseUrl = "http://cs.wikipedia.org/w/";

  final static String code     = "cs";
  final static String name     = "Czech Wikipedia";
  ...
  final static String checkWikiTraduction = "Wikipedie:WikiProjekt Check Wikipedia/Translation";
}
