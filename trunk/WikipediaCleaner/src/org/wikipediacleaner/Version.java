...
public final class Version {
  ...
  public final static Date   DATE = new GregorianCalendar(2014, Calendar.JANUARY, 22).getTime();
  ...
  public final static String MESSAGE =
    "<b>" +
    GT._("Check Wiki project has evolved a lot recently.") + " " +
    GT._("New detections have been added either with new error numbers or by replacing previously used error numbers.") + " " +
    GT._("You may need to update Check Wiki translation file on your wiki to configure the new detections.") + " " +
    "<br>" +
    GT._("I try to keep {0} up to date with Check Wiki, but if you find any discrepancy in the detections, please let me know.", PROGRAM) + " " +
    "</b><br><br>" +
